            ...
            <?php foreach($ticket as $row){ ?>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  ...
                  <span class="form-control-plaintext"><?= $row['nama']; ?></span>
                </div>
              </div>
              <div class="mb-3 row">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <span class="form-control-plaintext"><?= $row['category']; ?></span>
                </div>
              </div>
              <div class="mb-3 row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Message</label>
                <div class="col-sm-10">
                  <textarea style="height: 150px" readonly class="form-control-plaintext" id="staticEmail"><?= $row['message']; ?>
                  </textarea>
                </div>
              </div>
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <span class="form-control-plaintext"><?= $row['tanggal_update']; ?></span>
                </div>
              </div>
              <div class="mb-3 row">
