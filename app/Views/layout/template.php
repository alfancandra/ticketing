    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="/ticket"><span class="text-light">Admin</span></a>
          <a class="sidebar-brand brand-logo-mini" href="/ticket"><span class="text-light">Admin</span></a>
        </div>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/ticketaktif">Ticket Aktif</a></li>
                <li class="nav-item"> <a class="nav-link" href="/ticketnonaktif">Ticket Non Aktif</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © company 2021</span>
